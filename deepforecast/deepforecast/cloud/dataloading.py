...
from anyforecast.anyforecast.celeryapp import cloud, base
...
class LoadPandas(base.BaseTask):
    ...
    def run(
    ...
    ) -> Union[pd.DataFrame, Tuple[pd.DataFrame, TimeseriesSchema]]:
        """Loads pandas DataFrame.
        ...
        dataloader_creator = cloud.DataloaderCreator(user)
